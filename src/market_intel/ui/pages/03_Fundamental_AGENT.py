...
from market_intel.ui.screens.agents.fundamental import render as render_screen

st.set_page_config(page_title="Fundamental AGENT", layout="wide")
inject_terminal_theme()
inject_card_css()
render_sidebar_nav("fundamental_agent")
