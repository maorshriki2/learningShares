...
from market_intel.ui.screens.agents.final_verdict import render as render_screen

st.set_page_config(page_title="FINAL VERDICT LEARNING AGENT", layout="wide")
inject_terminal_theme()
inject_card_css()
render_sidebar_nav("final_verdict_learning_agent")
